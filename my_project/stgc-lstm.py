...
from keras.layers import Dropout, Dense, Input, LSTM, concatenate, ConvLSTM2D
...
class Sgcn_Lstm():
    ...
    def train(self):
        ...
        checkpoint = ModelCheckpoint("models/best_model.hdf5", monitor='val_loss', save_best_only=True, mode='auto', period=1)
